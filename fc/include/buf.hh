...
namespace fc {
  ...
  struct Buf {
    ...
    _INLINE Buf& operator<<(unsigned long long l) { char s[21]; return this->append(s, jeaiii::to_text_from_integer(s, l) - s); }
    _INLINE Buf& operator<<(long long l) { char s[21]; return this->append(s, jeaiii::to_text_from_integer(s, l) - s); }
    _INLINE Buf& operator<<(int i) { char s[12]; return this->append(s, jeaiii::to_text_from_integer(s, i) - s); }
    _INLINE Buf& operator<<(long i) {  char s[12]; return this->append(s, jeaiii::to_text_from_integer(s, i) - s); }
    _INLINE Buf& operator<<(unsigned long i) { char s[11]; return this->append(s, jeaiii::to_text_from_integer(s, i) - s); }
    _INLINE Buf& operator<<(unsigned int ui) { char s[11]; return this->append(s, jeaiii::to_text_from_integer(s, ui) - s); }
    _INLINE Buf& operator<<(short a) { char s[6]; return this->append(s, jeaiii::to_text_from_integer(s, a) - s); }
    _INLINE Buf& operator<<(unsigned short ua) { char s[6]; return this->append(s, jeaiii::to_text_from_integer(s, ua) - s); }
