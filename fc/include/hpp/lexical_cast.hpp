...
#define _INLINE inline __attribute__((always_inline))
  ...
  template <typename S, typename T, std::enable_if_t<std::is_same<long long, T>::value || std::is_same<unsigned long long, T>::value ||
    std::is_same<double, T>::value || std::is_same<float, T>::value || std::is_same<long double, T>::value || std::is_same<string, T>::value
  >* = nullptr> _INLINE S lexical_cast(T & i);
  template <> inline string lexical_cast<string>(long long& i) { char s[20]; return string(s, i64toa(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned long long& i) { char s[20]; return string(s, u64toa(s, i) - s); }
  template <> inline string lexical_cast<string>(double& f) { char s[20]; return string(s, milo::dtoa(f, s, 0x10)); }
  template <> inline string lexical_cast<string>(float& f) { char s[10]; return string(s, milo::dtoa(f, s, 0x7)); }
  ...
  template <typename S, typename T, std::enable_if_t<std::is_same<long long, T>::value || std::is_same<unsigned long long, T>::value ||
    std::is_same<double, T>::value || std::is_same<float, T>::value || std::is_same<long double, T>::value || std::is_same<string, T>::value
  >* = nullptr> _INLINE S lexical_cast(T && i);
  template <> inline string lexical_cast<string>(long long&& i) { char s[20]; return string(s, i64toa(s, std::move(i)) - s); }
  template <> inline string lexical_cast<string>(unsigned long long&& i) { char s[20]; return string(s, u64toa(s, std::move(i)) - s); }
  template <> inline string lexical_cast<string>(double&& f) { char s[20]; return string(s, milo::dtoa(std::move(f), s, 0x10)); }
  template <> inline string lexical_cast<string>(float&& f) { char s[10]; return string(s, milo::dtoa(std::move(f), s, 0x7)); }
  template <> inline string lexical_cast<string>(long double&& f) { return to_string(std::move(f)); }//milo not support
  template <> inline string lexical_cast<string>(string&& c) { return c; }
  template <typename S, typename T, std::enable_if_t<!std::is_same<long long, T>::value && !std::is_same<unsigned long long, T>::value && !
    std::is_same<double, T>::value && !std::is_same<float, T>::value && !std::is_same<long double, T>::value && !std::is_same<string, T>::value
  >* = nullptr> _INLINE S lexical_cast(T i);
  template <> inline string lexical_cast<string>(char i) { char s[4]; return string(s, a2a(s, i) - s); }
  template <> inline string lexical_cast<string>(signed char i) { char s[4]; return string(s, a2a(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned char i) { char s[3]; return string(s, h2a(s, i) - s); }
  template <> inline string lexical_cast<string>(short i) { char s[6]; return string(s, s2a(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned short i) { char s[5]; return string(s, t2a(s, i) - s); }
