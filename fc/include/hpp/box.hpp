...
public:
  ...
  box(box<T>&& _) noexcept: p(std::move(_.p)), b(std::move(_.b)) {}
  box(box<T>& _) noexcept: p(_.p), b(_.b) {}
  box(T&& _) noexcept: p(std::move(_)), b(true) {}
  box(T& _) noexcept: p(_), b(true) {}
  box(T* _) noexcept { _ ? b = true, p = *_ : b = false, p = 0; }
  template<typename... X>
  box(X&&... _) noexcept: p(std::forward<X>(_)...), b(true) {}
  box(const box<T>& _) noexcept: p(_.p), b(true) {}
