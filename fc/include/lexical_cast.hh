...
#define _INLINE inline __attribute__((always_inline))
  ...
  template <> inline string lexical_cast<string>(unsigned char& i) { char s[4]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(short& i) { char s[6]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned short& i) { char s[6]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(int& i) { char s[12]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned int& i) { char s[11]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(long long& i) { char s[21]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(unsigned long long& i) { char s[21]; return string(s, jeaiii::to_text_from_integer(s, i) - s); }
  template <> inline string lexical_cast<string>(bool& b) { return b ? STD_TURE : STD_FALSE; }
  template <> inline string lexical_cast<string>(double& f) { return to_string(f); }
  template <> inline string lexical_cast<string>(float& f) { return to_string(f); }
  template <> inline string lexical_cast<string>(long double& f) { return to_string(f); }
  template <> inline string lexical_cast<string>(long unsigned& f) { return to_string(f); }
  template <> inline string lexical_cast<string>(long& f) { return to_string(f); }
