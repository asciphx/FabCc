...
#if __FreeBSD__ >= 11 && !defined(__DragonFly__)
 return recvmmsg(fd, (struct mmsghdr*) mmsg, vlen, 0 , NULL );
#else
 return errno = ENOSYS, -1;
#endif
